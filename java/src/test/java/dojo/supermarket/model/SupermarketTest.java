...
public class SupermarketTest {
    ...
    public void buy_two_get_one_free() {
        ...
        theCart.addItem(toothbrush);
        theCart.addItem(toothbrush);
        Offer offer = new Offer(SpecialOfferType.THREE_FOR_TWO, toothbrush, catalog.getUnitPrice(toothbrush));
    ...
    public void percent_discount() {
        theCart.addItem(rice);
        Offer offer = new Offer(SpecialOfferType.TEN_PERCENT_DISCOUNT, rice, 10.0);
    ...
    public void xForY_discount() {
        ...
        theCart.addItem(cherryTomatoes);
        Offer offer = new Offer(SpecialOfferType.TWO_FOR_AMOUNT, cherryTomatoes, .99);
    ...
    public void FiveForY_discount() {
        theCart.addItemQuantity(apples, 5);
        Offer offer = new Offer(SpecialOfferType.FIVE_FOR_AMOUNT, apples, 6.99);
    ...
    public void FiveForY_discount_withSix() {
        ...
        Offer offer = new Offer(SpecialOfferType.FIVE_FOR_AMOUNT, apples, 5.99);
        teller.addSpecialOffer(offer, apples);
        Receipt receipt = teller.checksOutArticlesFrom(theCart);
        Approvals.verify(new ReceiptPrinter(40).printReceipt(receipt));
    }
    ...
    public void FiveForY_discount_withSixteen() {
        ...
        Offer offer = new Offer(SpecialOfferType.FIVE_FOR_AMOUNT, apples, 7.99);
        teller.addSpecialOffer(offer, apples);
        Receipt receipt = teller.checksOutArticlesFrom(theCart);
        Approvals.verify(new ReceiptPrinter(40).printReceipt(receipt));
    }
    ...
    public void FiveForY_discount_withFour() {
        ...
        Offer offer = new Offer(SpecialOfferType.FIVE_FOR_AMOUNT, apples, 8.99);
        teller.addSpecialOffer(offer, apples);
        Receipt receipt = teller.checksOutArticlesFrom(theCart);
        Approvals.verify(new ReceiptPrinter(40).printReceipt(receipt));
    }
